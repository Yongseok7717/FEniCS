...
for i in range(iMin,iMax):
    ...
    # since our initial internal variables are zero
        ...
        Nt=pow(2,j)    # mesh density and number of time steps
        dt = T/Nt      # time step
        ...
        error_DisplacementForm[j-jMin,0]=Nt; error_DisplacementForm[j-jMin,1]=err0; error_DisplacementForm[j-jMin,2]=err1; error_DisplacementForm[j-jMin,3]=err2;
...
for i in range(iMin,iMax):
    ...
    # since our initial internal variables are zero
        ...
        Nt=pow(2,j)# the number of timesteps
        dt = T/Nt      # time step
        ...
        error_VelocityForm[j-jMin,0]=Nt; error_VelocityForm[j-jMin,1]=err0; error_VelocityForm[j-jMin,2]=err1; error_VelocityForm[j-jMin,3]=err2;
...
print('')
print('Tables for P2 with fixed spatial mesh size ')
